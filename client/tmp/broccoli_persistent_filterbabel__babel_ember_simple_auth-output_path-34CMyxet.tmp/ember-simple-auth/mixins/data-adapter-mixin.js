define("ember-simple-auth/mixins/data-adapter-mixin", ["exports"], function (_exports) {
  ...
  (true && !(false) && Ember.deprecate("Ember Simple Auth: The DataAdapterMixin is now deprecated; call the session service's invalidate method in the adapter's handleResponse method instead in case of a 401 response.", false, {
